...
2. Stos Technologiczny i Optymalizacja
...
3. Architektura Docker
  System jest w pełni skonteneryzowany i podzielony na 3 segmenty: frontend (serwer
  Nginx), backend (Node.js) oraz bazę danych (PostgreSQL), komunikujące się wewnątrz bezpiecznej sieci
  wirtualnej.
